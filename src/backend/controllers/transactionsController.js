...
const addTransaction = async (req, res) => {
  const {
    name, cardNumber, expDate, ccv, amount, date, userId, reservationId,
  } = req.body;
...
module.exports = {
  addTransaction, getTransaction, getAllTransactions, getTransactionsByUserID, getTransactionByReservationID,
};
